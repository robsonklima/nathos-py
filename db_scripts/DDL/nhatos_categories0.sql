...
CREATE TABLE `categories` (
  ...
  CONSTRAINT `fk_categories_project_id` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2019-01-28 20:29:53
