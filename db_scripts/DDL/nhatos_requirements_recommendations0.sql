...
CREATE TABLE `requirements_recommendations` (
  ...
  CONSTRAINT `fk_requirements_recommendations_project_id` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_requirements_recommendations_recommendation_id` FOREIGN KEY (`recommendation_id`) REFERENCES `recommendations` (`recommendation_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `requirements_recommendations` VALUES (52,207,48759,1,'2019-01-23 21:55:40'),(53,207,48778,1,'2019-01-23 21:55:42'),(54,207,48754,0,'2019-01-23 21:55:46'),(55,207,48758,0,'2019-01-23 21:55:48'),(56,206,49895,1,'2019-01-28 15:05:03'),(57,206,49899,0,'2019-01-28 15:05:04'),(58,206,49891,0,'2019-01-28 15:05:06');
...
-- Dump completed on 2019-01-28 20:29:51
